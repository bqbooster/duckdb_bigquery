...
namespace duckdb {
	...
	static void * bigquery_free_result(BIGQUERY_RES *res) { return nullptr; } // TODO: Implement this function
...
public:
	BigQueryResult(BIGQUERY_RES *res_p, idx_t field_count) : res(res_p), field_count(field_count) {
	}
